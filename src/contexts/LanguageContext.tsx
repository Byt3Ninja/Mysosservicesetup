...
const translations = {
  en: {
    ...
    'help.when.needed': 'Help when you need it most',
    ...
    'save.location.details': 'Save location details for quick access',
    'address.label': 'Address Label',
    'work': 'Work',
    'other': 'Other',
    'custom.label': 'Custom Label',
    'enter.custom.label': 'e.g., Sister, Brother, Friend',
    'person.name': 'Person Name',
    'enter.person.name': 'Enter full name',
    'street.address': 'Street Address',
    'enter.street.address': 'Enter street name',
    'building.details': 'Building Details (Optional)',
    'building': 'Building',
    'floor': 'Floor',
    'apartment': 'Apt',
    'landmarks.optional': 'Nearby Landmarks (Optional)',
    'enter.landmarks': 'e.g., Near City Mall, Behind Gas Station',
    'landmarks.help': 'Help emergency team find the location faster',
    'address.save.info': 'This address will be saved for quick selection during emergencies',
    'save.address': 'Save Address',
    'error.custom.label': 'Please enter a label for this address',
    'error.person.name': 'Please enter the person\'s name',
    'error.street': 'Please enter the street address',
  ...
  ar: {
    ...
    'help.when.needed': 'مساعدة عند الحاجة',
    ...
    'save.location.details': 'حفظ تفاصيل الموقع للوصول السريع',
    'address.label': 'علامة العنوان',
    'work': 'عمل',
    'other': 'آخر',
    'custom.label': 'علامة مخصصة',
    'enter.custom.label': 'مثل، أخت، أخ، صديق',
    'person.name': 'اسم الشخص',
    'enter.person.name': 'أدخل الاسم الكامل',
    'street.address': 'عنوان الشارع',
    'enter.street.address': 'أدخل اسم الشارع',
    'building.details': 'تفاصيل المبنى (اختياري)',
    'building': 'المبنى',
    'floor': 'الطابق',
    'apartment': 'شقة',
    'landmarks.optional': 'معالم قريبة (اختياري)',
    'enter.landmarks': 'مثل، بالقرب من مجمع المدينة، خلف محطة الوقود',
    'landmarks.help': 'مساعدة فريق الطوارئ في العثور على الموقع بشكل أسرع',
    'address.save.info': 'سيتم حفظ هذا العنوان للاختيار السريع خلال حالات الطوارئ',
    'save.address': 'حفظ العنوان',
    'error.custom.label': 'يرجى إدخال علامة لهذا العنوان',
    'error.person.name': 'يرجى إدخال اسم الشخص',
    'error.street': 'يرجى إدخال عنوان الشارع',
